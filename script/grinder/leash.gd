...
var posPrev: PackedVector3Array
var pointCount: int
...
func init_position()->void:
	for i in range(pointCount):
		pos[i] = position + Vector3(constrain *i, 0, constrain * i)
		posPrev[i] = position + Vector3(constrain *i, 0, constrain * i)
